...
1. DONE - containerize the application
1. DONE - add deployments using heroku, digital ocean, etc...
   * Deployed to DigitalOcean droplet running docker: [zeal.mkwarman.com](https://zeal.mkwarman.com/)
